...
export default function BillSplitter() {
  ...
  const [editingItem, setEditingItem] = useState<Partial<
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-6 pb-24 lg:pb-4">
                ...
                <div className="space-y-3">
                  ...
                  {data.line_items.map((item) => {
                    const logic = data.split_logic.find(
                      (l) => l.item_id === item.id
                    );
                    ...
                    return (
                      ...
                      >
                        <div
                          ...
                          onClick={() =>
                            setActiveItemId(isExpanded ? null : item.id)
                          }
                        >
                    ...
                    <div>
                      ...
                      <div className="flex">
                        <select
                          ...
                          onChange={(e) =>
                            updateModifier("tip", "type", e.target.value)
                          }
